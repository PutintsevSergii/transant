...
- Source image: `src/assets/images/products/open-box/uno-multibox-33ft-eamnos/wagon-render.png`
...
- Concentrated-load capacity up to 70 t
...
| Wagon type | Eamnos |
| Number of axles | 4 |
| Distance between bogie pivots | 6.500 mm |
| Bogie type | Y25 with compact brake |
| Length over buffers | 11.500 mm |
| Wagon tare | 20.0 t |
| Loading length | 10.240 mm |
| Loading width | 2.707 mm |
| Loading area | 27.7 m² |
| Loading volume | 60.9 m³ |
