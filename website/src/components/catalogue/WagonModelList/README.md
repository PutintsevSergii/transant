...
- When it immediately follows the shared PageHero, its frame receives only the global 12 px hero handoff. It adds no other block padding or vertical margins; individual cards retain their own internal padding.
