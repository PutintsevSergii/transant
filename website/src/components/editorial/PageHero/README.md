...
- Optional `density`: defaults to `standard`. The `compact` variant reduces only wide-screen title/description scale for caller-owned dense page introductions; narrow/mobile typography stays unchanged.
