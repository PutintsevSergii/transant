...
The isolated fixture is `/fixtures/page-meta/`. Page-level Home, Company, Technology, German localization, responsive containment, axe, and visual checks provide the integration evidence at 320, 390, 768, 1024, 1440, and 844×390 CSS pixels.
