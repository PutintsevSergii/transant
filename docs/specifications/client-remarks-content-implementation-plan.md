...
### Certificate presentation follow-on — deferred by user

**Status:** `DEFERRED_BY_USER` as of 2026-09-08. Retain the current homepage and `/quality/` certificate presentation. The concept below is historical context only and must not be implemented without a new explicit request.
