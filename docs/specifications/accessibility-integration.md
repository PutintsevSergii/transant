...
The suite does not prove screen-reader output, physical assistive-device behavior, virtual-keyboard geometry, the unconfigured form-delivery service, or authenticated/device runtime behavior. Those remain explicitly scoped external or later-release evidence, not successful accessibility claims.
